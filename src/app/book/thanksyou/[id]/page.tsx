  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const apiUrl = `${apiUrlClinet}/order/thankyou/${id}`;
        console.log(apiUrl);
                  ...
                  <div className="component-29-parentThankYouOne">
                    <div className="component-29ThankYouOne">
                      <div className="zakir-khan-1-wrapperThankYouOne">
                        <div className="zakir-khan-1ThankYouOne">
                          {/* <img src="Image/cate20.png" alt="hello" /> */}
                        </div>
                      </div>
                    </div>
